...
* **제출일:** 2025년 06월 23일
* **저장소:** https://github.com/eryang11188/WebProgramming.git

**simple_todos_v4.json 파일도 첨부
(프로젝트에서 파일 확인하실 때 기능 확인이 용이)**
---
...
* **할 일 필터링:** (예: 전체, 완료됨, 미완료됨)
        ![거래 상태 정렬 전체 상태](<6-1. 필터링.png>)
        ![거래중 항목](<6-2. 필터링.png>)
        ![거래 완료 항목](6-3.필터링.png)
* **할 일 정렬:** (예: 최신순, 오래된순)
        ![마감일 빠른 순](<7-1. 할일 정렬(빠른순).png>)
...
* **보기방식 변경 요소 추가:** (클릭 시 테이블 형식->카드 형식)
        ...
        ![보기 방식 변경 : 카드 형식](<12-2. 보기방식 변경.png>)
